...
# backend_cfg.scene_dataset_config_file disabled for habitat-test-scenes
...
# audio_sensor.setAudioMaterialsJSON("data/mp3d_material_config.json")  # disabled for habitat-test-scenes
...
wavfile.write('data/output_binaural.wav', 16000, obs.T)
