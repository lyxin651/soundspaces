...
- Canonical conversion: world -> listener-local using explicit yaw rotation, RLR `[right,up,back]` -> DCASE `[front,left,up]` as `[W,-X_RLR,+Y_RLR,-Z_RLR]`, ACN `[W,Y_DCASE,Z_DCASE,X_DCASE]`, N3D->SN3D first-order scale `1/sqrt(3)`.
- Model-facing Golden: PASS; maximum angular error 3.078325e-06 degrees.
